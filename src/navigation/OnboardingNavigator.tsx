...
import { LocationStepScreen } from '../screens/onboarding/LocationStepScreen';
...
// Location) then optional details (Gender → Bio) with Skip, then Finish. Wrapped in the
  ...
  return (
    <OnboardingProvider>
      <Stack.Navigator screenOptions={{ headerShown: false, gestureEnabled: false, animation: 'slide_from_right' }}>
        ...
        <Stack.Screen name="Location" component={LocationStepScreen} />
