        ...
        <View style={styles.actions}>
          ...
          >
            ...
            <View style={styles.methodInfo}>
              ...
              <Text style={styles.methodHint}>We'll send you a verification code</Text>
            </View>
          ...
          >
            ...
            <View style={styles.methodInfo}>
              ...
              <Text style={styles.methodHint}>Quick sign up with your Google account</Text>
            </View>
            <Text style={styles.chevron}>›</Text>
          </Pressable>
          ...
          >
            ...
            <View style={styles.methodInfo}>
              ...
              <Text style={styles.methodHint}>Sign up using your Facebook profile</Text>
            </View>
            <Text style={styles.chevron}>›</Text>
          </Pressable>
